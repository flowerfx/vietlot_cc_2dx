...
namespace Utility
{
	...
	namespace wObject
	{
		...
		private:
			...
			Utility::xml::Wide_ObjectDec * p_xml_dec;
			//
			bool p_OnActionLock;
...
#pragma endregion normal_method
			...
			virtual	void		OnTouchBeginObject();
			virtual void		OnTouchMoveObject();
			virtual void		OnTouchEndObject();
			...
			void				SetTouchEnable(bool value, bool use_all_at_once = true);

			Vec2				GetDesignSize() { return design_size; }
		};
	}
}
