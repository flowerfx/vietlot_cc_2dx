...
namespace Utility
{
	namespace Texture
	{
		...
		///////////////////////////////////////////////////////////////////////////////
		Texture2D * ObjectTexture::GetTextureByName(const RKString & nameTexture)
		{
		...
		///////////////////////////////////////////////////////////////////////////////
		Sprite * ObjectTexture::GetSpriteByName(const RKString & nameSprite)
		{
		...
		///////////////////////////////////////////////////////////////////////////////
		Label * ObjectTexture::GetFontByName(const RKString & nameFont)
		{
		...
		///////////////////////////////////////////////////////////////////////////////
		void ObjectTexture::InsertTextureByName(const RKString & name, Texture2D * tex)
		{
			p_listTexture.insert(std::pair<RKString, Texture2D *>(name, tex));
		}
		
		///////////////////////////////////////////////////////////////////////////////
		void ObjectTexture::InsertSpriteByName(const RKString & name, Sprite * tex)
		{
			p_listSprite.insert(std::pair<RKString, Sprite *>(name, tex));
		}
		
		///////////////////////////////////////////////////////////////////////////////
		void ObjectTexture::InsertFontByName(const RKString & name, LabelDetail * tex)
		{
		...
		///////////////////////////////////////////////////////////////////////////////
		Texture2D * ObjectTexture::CreateTextureFromNamePath(const RKString & namepath, bool loadAA , int levelMipMap)
		{
			//create null image
			...
			{
				p_tex->initWithImage(p_AtlatSpriteObjectTemp, p_AtlatSpriteObjectTemp->getRenderFormat());
			}
		...
		void ObjectTexture::LoadTextureAtlas(const RKString & name, bool loadAA)
		{
		...
		void ObjectTexture::LoadTextureFrame(const RKString & name, bool loadAA )
		{
			if (XMLMgr->GetHarwardProfile() == xml::HARDWARE_HIGH || XMLMgr->GetHarwardProfile() == xml::HARDWARE_MED)
			{
				p_levelMipMap = 0;
			...
			const RKString & global_path_tex)
		{
			...
			{      
				...
				else if (!detail_str.Contains(":") && detail_str!= "")
				{
					...
					/*if (is_nine_path_texture)
					{
						SpriteFrameCache::getInstance()->addSpriteFrameWithCapInset(fr, full_name.GetString(), fr->GetCapInsert());
					}
					else*/
					{
		...
		void ObjectTexture::LoadTexturePacker(const RKString & name, bool loadAA)
		{
			if (XMLMgr->GetHarwardProfile() == xml::HARDWARE_HIGH || XMLMgr->GetHarwardProfile() == xml::HARDWARE_MED)
			{
				p_levelMipMap = 0;
			...
			for (auto it = font_dec.begin(); it != font_dec.end(); ++it)
			{
				...
				else
				{
					...
					if (!string)
					{
						string = Label::createWithTTF(
							"",
							(DataDir() + font_dec->path).GetString(),
							font_dec->d_size
						);
					}
#endif
		...
		///////////////////////////////////////////////////////////////////////////////
		TextBMPDetail * ObjectTexture::GetFontBmpByName(const RKString & nameFont)
		{
