...
namespace Utility
{
	namespace UI_Widget
	{
		...
		public:
			...
			void ScrollToItemIdxLoop(int idx, float time_to_idx, int number_loop, float time_each_loop);
			bool IsIndexInIndiceList(int idx);


			void UpdateCellAtIdx(int idx);

			Vec2 GetFirstDistanceMove();
