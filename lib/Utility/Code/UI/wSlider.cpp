...
namespace Utility
{
	namespace UI_Widget
	{
		...
		/////////////////////////////////////////////////////////////
		void SliderWidget::InitParam(const RKString & name, xml::UILayerWidgetDec * xml_value)
		{
		...
		void SliderWidget::InitTexture(xml::UILayerWidgetDec * xml_value)
		{
			...
			if (xml_value->GeneralValue->HaveDataVector2("size_ball"))
			{
				...
				_widget->setScaleSlideBall(size_ball);
			}
			...
			_widget->setScale9Enabled(p_isScale9Enable);
		...
		void SliderWidget::SetSize(const Vec2 & s)
		{
